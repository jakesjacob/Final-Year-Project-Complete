...
class Adafruit_RA8875 { // : public Adafruit_GFX {
 public:
  ...
  void	  dataWritePro(uint16_t x, uint16_t y, uint16_t foreColor, uint16_t bgColor, char data, uint16_t len=0);
  ...
  void boxDraw(int16_t x, int16_t y, int16_t length, int16_t height, int16_t thick, uint16_t color, uint16_t fill);
