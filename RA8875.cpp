...
void Adafruit_RA8875::dataWrite(char data)
{
    writeCommand(RA8875_MRWC);
        writeData(data);
}
...
void Adafruit_RA8875::dataWritePro(uint16_t x, uint16_t y, uint16_t foreColor, uint16_t bgColor, char data, uint16_t len)
{
    textMode();
    textSetCursor(x,y);
    textColor(foreColor, bgColor);
